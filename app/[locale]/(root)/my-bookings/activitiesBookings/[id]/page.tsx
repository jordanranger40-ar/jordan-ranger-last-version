...
import ActivityBookingDetailsUser from "@/components/userBookingPage/activitiesComponents/ActivityBookingDetails";
import ActivityBookingUserDetails from "@/components/userBookingPage/activitiesComponents/ActivityBookingUserDetails";
import ActivityDetails from "@/components/userBookingPage/activitiesComponents/ActivityDetails";
...
export default async function Page({ params }: Props) {
  ...
  const t = {
    ...
    bookingInfo:
      isArabic
        ? "راجع معلومات الحجز، تفاصيل النشاط، ومعلومات التواصل. إذا كان هناك خطأ يرجى الاتصال بالدعم."
        : "Review your booking information, activity details, and contact info. If anything looks wrong please contact support.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <ActivityBookingDetailsUser data={booking} locale={locale} />
            <ActivityDetails data={booking} locale={locale} />
          </div>

          <div className="space-y-6">
            <ActivityBookingUserDetails data={booking} locale={locale} />
