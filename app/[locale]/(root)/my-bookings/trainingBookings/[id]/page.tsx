...
import TrainingBookingDetails from "@/components/userBookingPage/trainingComponents/TrainingBookingDetails";
import TrainingUserDetails from "@/components/userBookingPage/trainingComponents/TrainingBookingUserDetails";
import TrainingDetails from "@/components/userBookingPage/trainingComponents/TrainingDetails";
...
export default async function Page({ params }: Props) {
  ...
  const t = {
    ...
    bookingInfo:
      isArabic
        ? "راجع معلومات الحجز، تفاصيل التدريب، ومعلومات المستخدم. إذا كان هناك خطأ يرجى الاتصال بالدعم."
        : "Review your booking information, training details, and user info. If anything looks wrong please contact support.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <TrainingBookingDetails data={booking} locale={locale} />
            <TrainingDetails data={booking} locale={locale} />
          </div>

          <div className="space-y-6">
            <TrainingUserDetails data={booking} locale={locale} />
