...
export default async function Page({ params }: Props) {
  ...
  const progress =
    capacity > 0 ? Math.min((numberOfBooked / capacity) * 100, 100) : 0;
      ...
      <section className="max-w-7xl mx-auto md:flex md:items-start md:gap-10">
        ...
        <aside className="md:w-1/3 flex flex-col gap-6 mt-6 md:mt-0">
            ...
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm text-gray-500">
                  {isArabic ? "تفاصيل التدريب" : "Training details"}
                </p>
          ...
          <div className="flex flex-col">
           ...
           {!training.coming_soon &&  <div className="grid grid-cols-2 gap-3 text-sm text-gray-700">
              <InfoCard
  ...
  return (
    <div className="w-full bg-gray-50 rounded-full h-3 overflow-hidden">
      <div
        ...
        style={{
          width: `${progress}%`,
          background: "linear-gradient(90deg, #8a9b45, #676e32, #505b27)",
        }}
