...
import { z } from "zod";
import { editActivity } from "@/app/models/db/lib/services/activities";
...
export async function editActivityAction(id:string,data: ActivityInput) {
...
;
  ...
  try {
    // 4️⃣ DB update
    const updated = await editActivity(id, parsed.data);
