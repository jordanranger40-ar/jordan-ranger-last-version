  ...
  return (
    <div
      className="bg-white rounded-3xl shadow-md p-8 flex flex-col items-center text-center 
                 transition-transform transform   hover:-translate-y-2 hover:shadow-xl overflow-hidden group  min-h-[230px]"
      style={{
    ...
    >
      ...
      <h3 className="text-[#2c3e50] text-lg font-semibold mb-2">
