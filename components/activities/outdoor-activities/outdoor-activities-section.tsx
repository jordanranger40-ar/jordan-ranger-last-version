  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-600 mb-16 max-w-3xl">
        {isArabic
          ? "استمتع بمجموعة متنوعة من الأنشطة الخارجية كل نشاط مصمم ليمنحك تجربة ممتعة ومميزة."
          : "Enjoy a variety of outdoor activities, each designed to give you a fun and unique experience."}
      </p>
