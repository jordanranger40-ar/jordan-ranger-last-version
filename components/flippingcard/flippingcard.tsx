...
const FlippingCard: React.FC<CardProps> = ({ data, isArabic }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-linear-to-tr from-white/0 via-white/10 to-white/0 opacity-0 transition duration-500 rounded-[2rem_0.5rem_2rem_0.5rem] hover:opacity-40" />
      </div>
    </div>
  );
};
