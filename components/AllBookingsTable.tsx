...
export function AllBookingTable<TData>({
  columns,
  data,
  routeName,
  ...
  const columnsWithActions: ColumnDef<TData>[] = [
    ...columns,
    {
      ...
      header: "Actions",
      cell: ({ row }) => {
        const rowData = row.original as TData & { id: string,type:string };
        return (
          <div className="flex gap-2">
            <Button
              size="sm"
              variant="outline"
              onClick={() => router.push(`${routeName}/${rowData.type}/${rowData.id}`)}
  ...
  return (
    <div className="space-y-4 mb-7 ml-0 mr-0 lg:ml-4 lg:mr-4 w-[90vw] md:w-full xl:w-full ">
