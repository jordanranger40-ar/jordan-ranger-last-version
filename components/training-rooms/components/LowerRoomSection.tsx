...
import LowerOne from "@/public/images/innerHall1.jpg"
import LowerTwo from "@/public/images/innerHall2.jpg"
import LowerThree from "@/public/images/innerHall3.jpg"
...
export default function LowerRoomSection({ isArabic }: Props) {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-28 mb-32 ">
      <h1 className="text-lg sm:text-xl md:text-3xl text-gray-600 font-semibold text-center mb-10">
        {isArabic ? "غرفة التدريب السفلى (30-20 مشاركًا)" : "Lower Training Room (20-30 Participants)"}
      </h1>
